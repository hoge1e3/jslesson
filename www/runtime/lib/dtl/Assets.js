root.system.run(function () {
  return AsyncByGenerator.toVal(
    function* () {
      this["Assets"] = yield* AsyncByGenerator.toGen(this["create"]());
      this["Assets"]["list"] = dtlbind(this, function (context) {
        ...
        return AsyncByGenerator.toVal(
          function* () {
            ...
            this["ls"] = yield* AsyncByGenerator.toGen(
              (yield* AsyncByGenerator.toGen(
                (yield* AsyncByGenerator.toGen(
                  this["Ajax"]["create"](this["ep"] + "a.php?Asset/list"),
                ))["data"](context),
              ))["get"](),
            );
            return yield* AsyncByGenerator.toGen(
              this["ls"]["map"](
                dtlbind(this, function (s) {
                  ...
                  return AsyncByGenerator.toVal(
                    function* () {
                      a = yield* AsyncByGenerator.toGen(s["split"]("/"));
      ...
      this["Assets"]["endPoint"] = dtlbind(this, function () {
        ...
        return AsyncByGenerator.toVal(
          function* () {
            return this["window"]["BitArrow"]["serverTop"];
          }.apply(this),
        );
      });
      this["Assets"]["load"] = dtlbind(this, function (path) {
        ...
        return AsyncByGenerator.toVal(
          function* () {
            a = yield* AsyncByGenerator.toGen(path["split"]("/"));
            ...
            return yield* AsyncByGenerator.toGen(
              (yield* AsyncByGenerator.toGen(
                (yield* AsyncByGenerator.toGen(
                  (yield* AsyncByGenerator.toGen(
                    this["Ajax"]["create"](this["ep"] + "a.php?Asset/download"),
                  ))["data"]("context", c),
                ))["data"]("filename", f),
              ))["get"](),
            );
            ...
            return yield* AsyncByGenerator.toGen(
              (yield* AsyncByGenerator.toGen(
                (yield* AsyncByGenerator.toGen(
                  (yield* AsyncByGenerator.toGen(
                    (yield* AsyncByGenerator.toGen(
                      this["Ajax"]["create"](this["ep"] + "a.php?Asset/upload"),
                    ))["data"]("context", c),
                  ))["data"]("filename", f),
