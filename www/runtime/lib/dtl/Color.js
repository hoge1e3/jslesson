root.system.run(function () {
  ...
  this["Color"]["fromCMYK"] = dtlbind(
    ...
    function (cyan, magenta, yellow, black) {
      ...
      return this["Color"]["create"](
        (1 - this["window"]["Math"]["min"](1, cyan * (1 - black) + black)) *
          255,
        (1 - this["window"]["Math"]["min"](1, magenta * (1 - black) + black)) *
          255,
        (1 - this["window"]["Math"]["min"](1, yellow * (1 - black) + black)) *
          255,
      );
    },
  );
  ...
  this["Light"]["mix"] = dtlbind(this, function () {
    ...
    var _rest = Array.prototype.slice.call(arguments, 0);
    var c;
    this["args"] = this["Array"]["prototype"]["slice"]["call"](_args);
  ...
  this["Color"]["mixColor"] = dtlbind(this, function () {
    ...
    var yyy;
    var m;
    args = this["Array"]["prototype"]["slice"]["call"](_args);
    args = args["select"](
      dtlbind(this, function (e) {
        var self = this;
        var 自分 = self;
