...
this['gyroSensor']['addAlias']("setAction","動作設定")['addAlias']("action","動作")['addAlias']("getYaw","ヨー?","水平方向の傾き?","水平の傾き?")['addAlias']("getRoll","ロール?","左右方向の傾き?","左右の傾き?")['addAlias']("getPitch","ピッチ?","上下方向の傾き?","上下の傾き?")['addAlias']("calibrate","調整")['addAlias']("use","使う");
...
this['aa']['call']((this['sp']),"position?","何文字目?");
this['aa']['call']((this['sp']),"substr","部分");
this['aa']['call']((this['sp']),"length?","長さ?");
this['aa']['call']((this['sp']),"partition","分割");
this['aa']['call']((this['sp']),"oneReplace","置き換える");
...
this['aa']['call']((this['np']),"fromCharCode","コード文字");
