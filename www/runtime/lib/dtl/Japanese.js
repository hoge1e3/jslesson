  ...
  return dtlbind(this, function () {
    ...
    ["execute"](
      dtlbind(this, function () {
        ...
        this["Color"]
          ["addAlias"]("randomCreate", "ランダムに作る")
          ["addAlias"]("toHalfOpacity", "半透明にする")
          ["addAlias"]("toFullOpacity", "不透明にする");
        ...
        this["Actor"]
          ["addAlias"]("forward", "歩く")
          ["addAlias"]("turnRight", "右回り")
          ["addAlias"]("turnLeft", "左回り")
          ["addAlias"]("moveTo", "位置")
          ["addAlias"]("moveBy", "移動する")
          ["addAlias"]("setDir", "向き")
          ["addAlias"]("getDir", "向き?")
          ["addAlias"]("bounce", "跳ね返る")
          ["addAlias"]("xpos?", "横の位置?")
          ["addAlias"]("ypos?", "縦の位置?")
          ["addAlias"]("die", "消える")
          ["addAlias"]("appear", "現れる")
          ["addAlias"]("collision", "衝突")
          ["addAlias"]("moveCenter", "中心に戻る");
        ...
        this["touchSensor"]
          ...
          [
            "addAlias"
          ]("getTouching", "タッチしている?", "タッチしてる?", "触れている?", "触れてる?")
          ["addAlias"]("getX", "横の位置?")
          ["addAlias"]("getY", "縦の位置?");
