...
this['Actor']['addAlias']("forward","歩く")['addAlias']("turnRight","右回り")['addAlias']("turnLeft","左回り")['addAlias']("moveTo","位置")['addAlias']("moveBy","移動する")['addAlias']("setDir","向き")['addAlias']("getDir","向き?")['addAlias']("bounce","跳ね返る")['addAlias']("xpos?","横の位置?")['addAlias']("ypos?","縦の位置?")['addAlias']("die","消える")['addAlias']("collision","衝突");
...
this['Label']['addAlias']("inc","増やす");
this['Label']['addAlias']("write","書く");
this['Label']['addAlias']("fontColor","文字色");
this['Label']['addAlias']("position","位置");
this['Label']['addAlias']("moveTo","移動する");
