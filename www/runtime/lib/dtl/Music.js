...
var a;
return AsyncByGenerator.toVal((function*() {mod=(yield* AsyncByGenerator.toGen(this['root']['load_mml_mod']()));
this['literalSet']=(yield* AsyncByGenerator.toGen(this['resolve'](((yield* AsyncByGenerator.toGen(this['root']['mml_ba_mod']['loadJapaneseRhysmLiteralSet']()))))));
(yield* AsyncByGenerator.toGen((this['window']['console'])['log']("loadRhysmLiteral",(this['literalSet']))));
