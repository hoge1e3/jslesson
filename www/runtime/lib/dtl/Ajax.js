root.system.run(function () {
  return AsyncByGenerator.toVal(
    function* () {
      this["Ajax"] = yield* AsyncByGenerator.toGen(this["create"]());
      this["Ajax"]["initialize"] = dtlbind(this, function (url) {
        ...
        return AsyncByGenerator.toVal(
          function* () {
            this["url"] = url;
            this["params"] = yield* AsyncByGenerator.toGen(
              this["system"]["new"](
        ...
        return AsyncByGenerator.toVal(
          function* () {
            yield* AsyncByGenerator.toGen(
              this["system"]["write"](this["params"], key, value),
            );
            this["method"] = "post";
            return this;
          }.apply(this),
            ...
            return yield* AsyncByGenerator.toGen(
              this["DtlPromise"]["new"](
                dtlbind(this, function (succ, err) {
                  ...
                  return AsyncByGenerator.toVal(
                    function* () {
                      this["opt"] = yield* AsyncByGenerator.toGen(
                        this["system"]["new"](
                          dtlbind(this, function () {
                            var self = this;
                            var 自分 = self;
