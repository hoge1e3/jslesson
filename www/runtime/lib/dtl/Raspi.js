root.system.run(function () {
  return AsyncByGenerator.toVal(
    function* () {
      this["Raspi"] = yield* AsyncByGenerator.toGen(this["create"]());
            ...
            yield* AsyncByGenerator.toGen(
              (yield* AsyncByGenerator.toGen(
                ...
                dtlbind(this, function () {
                  ...
                  return AsyncByGenerator.toVal(
                    function* () {
                      ba = this["window"]["BitArrow"];
                      ppath = ba["runtimePath"] + "lib/python/";
                      yield* AsyncByGenerator.toGen(
                        this["system"]["getScript"](ppath + "SerialControl.js"),
                      );
                      yield* AsyncByGenerator.toGen(
                        this["system"]["getScript"](ppath + "raspi_repl.js"),
                      );
                      this["rp"] = yield* AsyncByGenerator.toGen(
                        this["system"]["new"](this["window"]["RaspiREPL"]),
                      );
                      yield* AsyncByGenerator.toGen(this["rp"]["waitReady"]());
                      return yield* AsyncByGenerator.toGen(
                        this["exec"]("import machine"),
                      );
                    }.apply(this),
                  );
                }),
      ...
      this["Raspi"]["readADC"] = dtlbind(this, function (port, bytes) {
        ...
        return AsyncByGenerator.toVal(
          function* () {
            yield* AsyncByGenerator.toGen(this["connect"]());
            return yield* AsyncByGenerator.toGen(
              this["exec"]("print(machine.ADC(" + port + ").read_u16())"),
            );
          }.apply(this),
        );
      });
      ...
      this["Raspi"]["getTemperature"] = dtlbind(this, function () {
        ...
        return AsyncByGenerator.toVal(
          function* () {
            t = yield* AsyncByGenerator.toGen(this["readADC"](4));
      ...
      this["Raspi"]["writePin"] = dtlbind(this, function (port, value) {
        ...
        return AsyncByGenerator.toVal(
          function* () {
            yield* AsyncByGenerator.toGen(this["connect"]());
            scr =
              "machine.Pin(" + port + ", machine.Pin.OUT).value(" + value + ")";
      ...
      return (this["Raspi"]["led"] = dtlbind(this, function (value) {
        ...
        return AsyncByGenerator.toVal(
          function* () {
            return yield* AsyncByGenerator.toGen(this["writePin"](25, value));
          }.apply(this),
        );
      }));
    }.apply(this),
