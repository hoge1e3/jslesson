...
define(["Klass", "assert"], function (Klass, assert) {
    ...
    t.Base = Klass.define({
        ...
        assignableFrom: function assignableFrom(t) {
            //ctype.Base->Boolean
            return t === this;
        },
        // Check var_of_this = (t)var_of_t; is OK?
        castableFrom: function castableFrom(t) {
            //ctype.Base->Boolean
        ...
        extendModifiers: function extendModifiers(t) {
    ...
    t.Number = t.Primitive.inherit({
        assignableFrom: function assignableFrom(type) {
        ...
        castableFrom: function castableFrom(type) {
            if (type instanceof t.Number) return true;
    ...
    t.Unsigned = t.Number.inherit({
        ...
        numOrd: {
            get: function get() {
                return this.e.numOrd;
            }
        },
        equals: function equals(o) {
            return o instanceof t.Unsigned && this.e.equals(o.e);
        },
        cast: function cast(v) {
            v = this.e.cast(v);
            if (v < 0) {
    ...
    t.Long = t.Number.inherit({
        ...
        numOrd: {
            get: function get() {
                return this.e.numOrd + 1;
            }
        },
        equals: function equals(o) {
            return o instanceof t.Long && this.e.equals(o.e);
        },
        toLiteral: function toLiteral() {
    ...
    t.Short = t.Number.inherit({
        ...
        equals: function equals(o) {
            return o instanceof t.Short && this.e.equals(o.e);
        },
        toLiteral: function toLiteral() {
    ...
    t.Pointer = t.Base.inherit({
        ...
        assignableFrom: function assignableFrom(right) {
            /*if (right instanceof t.Number) {
                return true;
            }*/
            if (right instanceof t.Pointer) {
                return this.e instanceof t.Void || right.e instanceof t.Void || this.e.assignableFrom(right.e);
            }
            return t.Pointer.super(this, "assignableFrom", right);
        },
        equals: function equals(o) {
            return o instanceof t.Pointer && this.e.equals(o.e);
        },
        binOpable: function binOpable(op, right) {
            // TODO: === in C??
    ...
    t.Array = t.Pointer.inherit({
        ...
        equals: function equals(o) {
            return o instanceof t.Array && this.e.equals(o.e);
        },
        sizeOf: function sizeOf() {
    ...
    t.Function = t.Base.inherit({
        ...
        toLiteral: function toLiteral() {
            return CTYPE_NAME + ".Function(" + this.ret.toLiteral() + ",[" + this.args.map(function (e) {
                return "{vname:'" + e.vname + "', vtype:" + e.vtype.toLiteral() + "}";
            }).join(",") + "])";
        },
        match: function match(argTypes) {
            ...
            if (len !== argTypes.length) {
                return ["引数の数が違います．関数定義では" + "{1}個受け取るよう指定されていますが，" + "呼び出し側では{2}個渡しています", len, argTypes.length];
        ...
        equals: function equals(o) {
            return o instanceof t.Function && this.ret.equals(o.ret) && alleq(this.args, o.args);
            function alleq(a, b) {
    ...
    t.Struct = t.Base.inherit({
        ...
        toLiteral: function toLiteral(deep) {
            if (!deep && this.name) {
                if (this.name) return "scopes_0." + this.name; //TODO: SCOPES
            } else {
                return CTYPE_NAME + ".Struct('" + this.name + "',[" + this.members.map(function (e) {
                    return e.toLiteral();
                }).join(",") + "])";
            }
        },
        addMember: function addMember(vtype, name) {
