...
// Edit www/js/ctrans//lib.js Instead.
...
(function () {
    var callAssetAPI = function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(cmd, params) {
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.prev = 0;
                            _context.next = 3;
                            return $.ajax(window.BitArrow.runtimePath + ("a.php?Asset/" + cmd), { method: "POST", data: params });
        ...
        return function callAssetAPI(_x, _x2) {
    ...
    _global.fopen = function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(file, mode) {
            var useRemote, fp, f, _useRemote, _, context, filename, e, t, _f, _useRemote2, _2, _context2, _filename, _e, _t;
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            ...
                            useRemote = /^(user|class)\/(.*)/.exec(file);
                            ...
                            return _context3.abrupt("return", _global.NULL);
                        ...
                        case 13:
                            _useRemote = _slicedToArray(useRemote, 3), _ = _useRemote[0], context = _useRemote[1], filename = _useRemote[2];
                            _context3.next = 16;
                            return callAssetAPI("exists", { context: context, filename: filename });
                        ...
                        case 19:
                            _context3.next = 21;
                            return callAssetAPI("download", { context: context, filename: filename });
                        ...
                        case 30:
                            ...
                            if (!_f.exists()) {
                                ...
                                fp.text = _f.text();fp.pos = fp.text.length;
                            }
                            _context3.next = 50;
                            break;

                        case 36:
                            _useRemote2 = _slicedToArray(useRemote, 3), _2 = _useRemote2[0], _context2 = _useRemote2[1], _filename = _useRemote2[2];
                            _context3.next = 39;
                            return callAssetAPI("exists", { context: _context2, filename: _filename });
                        ...
                        case 45:
                            _context3.next = 47;
                            return callAssetAPI("download", { context: _context2, filename: _filename });
                        ...
                        case 53:
                            return _context3.abrupt("return", fp);
    ...
    _global.fclose = function () {
        var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(fp) {
            var _fp$useRemote, _, context, filename;
                ...
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            ...
                            throw new Error("fclose: 引数がファイルではありません");
                        ...
                        case 2:
                            ...
                            throw new Error("fclose: このファイルはすでに閉じられています");
                        ...
                        case 9:
                            _fp$useRemote = _slicedToArray(fp.useRemote, 3), _ = _fp$useRemote[0], context = _fp$useRemote[1], filename = _fp$useRemote[2];
                            _context4.next = 12;
                            return callAssetAPI("upload", { context: context, filename: filename, content: fp.text });
