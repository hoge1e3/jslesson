...
(function( factory ) {
	if (false/*@hoge1e3*/ && typeof define === "function" && define.amd ) {
...
var cssRules=[
    ...
    ".ui-dialog .ui-dialog-titlebar-close { position: absolute; right: 0.3em; top: 50%; width: 21px; margin: -10px 0px 0px; padding: 1px; height: 20px; background-image: url(\"images/ui-icons_222222_256x240.png\"); background-position: -96px -128px; }",
    ...
    ".ui-menu .ui-menu-item { margin: 0px; padding: 0px; width: 100%; list-style-image: url(\"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\"); }",
