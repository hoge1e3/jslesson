Tonyu.klass.define({
  ...
  includes: [],
  methods: {
    main :function _trc_Foo2_main() {
      "use strict";
      var _this=this.isTonyuObject?this:Tonyu.not_a_tonyu_object(this);
      
      $LASTPOS=1000047;//user.Foo2:47
      _this.ra=$("body");
      $LASTPOS=1000062;//user.Foo2:62
      _this.ra.empty();
      $LASTPOS=1000075;//user.Foo2:75
      _this.x=3;
      $LASTPOS=1000081;//user.Foo2:81
      _this.y=5;
      $LASTPOS=1000087;//user.Foo2:87
      $("<div>").text(_this.x+_this.y).appendTo(_this.ra);
      $LASTPOS=1000123;//user.Foo2:123
      _this.cv=$("<canvas>").attr({width: 300,height: 300}).appendTo(_this.ra);
      $LASTPOS=1000183;//user.Foo2:183
      _this.c=_this.cv[0].getContext("2d");
      $LASTPOS=1000210;//user.Foo2:210
      _this.c.fillRect(20,50,100,20);
    },
    fiber$main :function _trc_Foo2_f_main(_thread) {
      "use strict";
      var _this=this.isTonyuObject?this:Tonyu.not_a_tonyu_object(this);
