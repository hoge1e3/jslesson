    ...
    return {
      ...
      waitLoadLib :function _trc_Graph_waitLoadLib() {
        ...
        if (! window.Plotly) {
          ...
          _it_147=Tonyu.iterator(_this.loadLibHandlers,1);
          while(_it_147.next()) {
            f=_it_147[0];
      ...
      freq :function _trc_Graph_freq(k) {
        ...
        _it_169=Tonyu.iterator(_this.vec(k),1);
        while(_it_169.next()) {
          o=_it_169[0];
      ...
      sum :function _trc_Graph_sum(k) {
        ...
        if (typeof  (k)==="object") {
          ...
          _it_185=Tonyu.iterator(_this.vec(k),1);
          while(_it_185.next()) {
            v=_it_185[0];
      ...
      dev :function _trc_Graph_dev(k) {
        ...
        if (k===undefined) {
          ...
          a=_this.mean(k);
          _it_190=Tonyu.iterator(_this.vec(k),1);
          while(_it_190.next()) {
            v=_it_190[0];
  ...
  methods: function (__superClass) {
    return {
      ...
      callServer :function _trc_Parent_callServer(url,stdin) {
        ...
        p = new window.Promise((function anonymous_13614(s) {
          var ifrm;
          
          window.sendResult=(function anonymous_13648(r) {
